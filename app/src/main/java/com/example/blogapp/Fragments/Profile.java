...
public class Profile extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return binding.getRoot(); //binding got initialize
    ...
    private void initvar() {
        account = GoogleSignIn.getLastSignedInAccount(getContext()); //details of signed in account
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        signInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() { //logout from google auth
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                dialog.dismiss();
                                startActivity(new Intent(getContext().getApplicationContext(), SplashActivity.class));
                                getActivity().finish();
                            }
                        });
                    }
